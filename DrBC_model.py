...
class DrBC():
    ...
    def Encoder_Decoder(self,edge_index,num_nodes):
        ...
        adj, deg  =self.adjcent_with_wewight(edge_index,num_nodes)
    ...
    def train(self,episode,num_nodes):
        ...
        for i in range(episode):
            ...
            loss_sum = self.optimal(loss_)
            
            loss_list.append(float(loss_sum))
            
        return(pred,loss_list)
    
    def predict(self,graph,score,num_nodes):
        loss_list = []
    ...
    def adjcent_with_wewight(self,edge_index,num_nodes):
